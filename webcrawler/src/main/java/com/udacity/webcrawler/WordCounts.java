...
final class WordCounts {
  ...
  static Map<String, Integer> sort(Map<String, Integer> wordCounts, int popularWordCount) {
    ...
    return wordCounts.entrySet().stream().sorted(new WordCountComparator()).limit(popularWordCount).collect(Collectors.toMap(ent -> ent.getKey(),ent-> ent.getValue(),(ent1,ent) -> ent1, LinkedHashMap::new));
  }
